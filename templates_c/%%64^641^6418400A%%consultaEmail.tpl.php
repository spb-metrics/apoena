<?php /* Smarty version 2.6.6, created on 2010-09-06 08:45:22
         compiled from consultaEmail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'consultaEmail.tpl', 1, false),array('function', 'cycle', 'consultaEmail.tpl', 80, false),)), $this); ?>
...
<table width="778" cellpadding="0" CLASS="txtCompromissoAzul" border="0">    
	...
	<?php if (count($_from = (array)$this->_tpl_vars['codConfig'])):
...
">
			<td width="300"> <span CLASS="txtAzulClaro"> <?php echo $this->_tpl_vars['email'][$this->_tpl_vars['i']]; ?>
</span></a></td>
			<td width="300" colspan="2"><span CLASS="txtAzulClaro"><?php echo $this->_tpl_vars['host'][$this->_tpl_vars['i']]; ?>
</span></td>
			<td width="100	" colspan="2"><span CLASS="txtAzulClaro"><?php echo $this->_tpl_vars['porta'][$this->_tpl_vars['i']]; ?>
</span></td>
		</tr>
