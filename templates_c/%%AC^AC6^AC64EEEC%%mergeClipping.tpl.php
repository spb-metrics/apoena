<?php /* Smarty version 2.6.6, created on 2009-12-16 09:25:04
         compiled from mergeClipping.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'mergeClipping.tpl', 1, false),array('function', 'cycle', 'mergeClipping.tpl', 109, false),)), $this); ?>
	...
	<tr>
		<td>
			<!--
			    ...
			    Este programa está nomeado como mergeClipping.tpl e possui 135
				linhas de código. 
...
<table width="778" cellpadding="0" CLASS="txtCompromissoAzul" border="0">
	<tr>
		<td align="center" colspan="3">
			<span CLASS="txtAzul12"> Tela Juntar Clipping</span>
		</td>
	</tr>	
	<tr>	
	...
	<tr>
		<td align="center">
				...
				<?php if ($this->_tpl_vars['campo'] == 'branco'): ?>
					<span CLASS="alerta">Selecione um ou mais itens para o Juntada de Clipping  </span>
				<?php endif; ?>
		</td>	
	</tr>
</table>
<table width="778" cellpadding="0" CLASS="txtCompromissoAzul" border="0">
	...
	<tr>
		<td align="left">
			<span CLASS="txtAzulClaro">Nome do Clipping Juntado: </span>
		</td>
</table>	
<table width="778" cellpadding="0" CLASS="txtCompromissoAzul" border="0">	
	<tr>
		<td align="left">  
        	<input type="text" size="50" class="input" name="nomeMergeClipping">
        </td>
	</tr>
    <tr>
    	<td>
...
<table width="778" cellpadding="0" CLASS="txtCompromissoAzul" border="0">    
    <tr>
    	<td align="right" colspan="2"> 
        	<p>
          		<input type="submit" name="Submit" CLASS="txtAlteraAzul" value="montar merge">
          	</p>
      </td>
    </tr>
